...
import { MainContainer, Category, CategoryTitle, BrandCategory, MiddleCategory, BrandList, BrandAttribute, OtherCategory, CategoryName, ItemSection, Items, SelectBox, SortBox, ListBox } from './styles';
      ...
      <Category>
        ...
        <BrandCategory>
          <CategoryName>
            ...
            <div>
              <form>
                <input type="text" title="브랜드 검색" onChange={e => {
        ...
        <CategoryName>가격</CategoryName>
          <div className='price'>
            <ul>
              <li style={{"fontWeight":"bold", "color":"black"}}>전체보기</li>
              <li>~ 50,000원</li>
              <li>50,000원 ~ 80,000원</li>
              <li>80,000원 ~ 110,000원</li>
              <li>110,000원 ~ 130,000원</li>
              <li>130,000원 ~</li>
              ...
              <li className='li_outer'>
                <div className='li_inner'>
                  <div className='list_img'>
                    <a href="/detail"><img src={data.url}></img></a>
                  </div>
