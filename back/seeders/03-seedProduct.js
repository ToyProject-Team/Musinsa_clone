...
module.exports = {
    async up(queryInterface, Sequelize) {
        ...
        var dummyProduct = [];
        var randPrices = [];
        const categoryImgCOunt = [
            180, 180, 180, 34, 180, 180, 180, 180, 90, 180, 180, 180, 180, 180,
            180, 140, 156, 172, 186, 180, 180, 172,
        ];
        ...
        let sum = 0;
        let Idx = 0;
        let dividedCount = parseInt(
            categoryImgCOunt[Idx] / categoryitemsCount[Idx],
        );
        let ImgSmallIdx = 0;
        ...
        for (var i = 0; i < categoryImgCOunt.reduce((a, b) => a + b); i++) {
            ...
            dummyProduct.push({
                ...
                productPrice:
                    (nonMemberPriceValue / 100) * premium(rand(0, 60)),
                ...
                beRleased: faker.date.between(
                    '2022-07-09T00:00:00.000Z',
                    '2022-09-31T00:00:00.000Z',
                ),
    ...
    async down(queryInterface, Sequelize) {
        await truncateForce(queryInterface, 'Products');
    },
};
